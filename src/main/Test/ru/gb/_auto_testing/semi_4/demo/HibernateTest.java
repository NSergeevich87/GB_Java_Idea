package ru.gb._auto_testing.semi_4.demo;
...
public class HibernateTest {
    ...
    @Test
    void testHQL() {
        final org.hibernate.Query query = getSession().createQuery("from " + "EmployeeEntity");
        ...
        final Query queryWhere = (Query) getSession().createQuery("from " + "EmployeeEntity" + " where id=" + 2);
    ...
    @Test
    void testSQL() {
        final Query query = (Query) getSession().createSQLQuery("select * from employee").addEntity(EmployeeEntity.class);
        System.out.println("executing: " + query.getQueryString());
        List<EmployeeEntity> employeeEntities = query.list();
        for (EmployeeEntity entity : employeeEntities) {
            System.out.println("  " + entity);
        ...
        Query queryNameAndCapacity = (Query) getSession().createSQLQuery(sql);
    ...
    void testAddAndDelete() {
        ...
        final Query queryWhere = (Query) session.createQuery("from " + "EmployeeEntity" + " where id=" + id);
        System.out.println("executing: " + queryWhere.getQueryString());
        ...
        final Query queryWhereAfterUpdate = (Query) session.createQuery("from " + "EmployeeEntity" + " where id=" + id);
        System.out.println("executing: " + queryWhere.getQueryString());
        ...
        final Query query = (Query) session.createQuery("from " + "EmployeeEntity");
        System.out.println("executing: " + query.getQueryString());
